...
public class BattleManager : MonoBehaviour
{
    ...
    public AudioClip attackClip, damageClip, pokeballClip, levelUpClip, faintedClip, endBattleClip;
    ...
    public IEnumerator SetupBattle()
    {
        ...
        else
        {
            ...
            yield return trainerImage.transform.DOLocalMoveX(trainerImage.transform.localPosition.x + 400, 0.5f)
                .WaitForCompletion();
            ...
            yield return playerImage.transform.DOLocalMoveX(playerImage.transform.localPosition.x - 400, 0.5f)
                .WaitForCompletion();
            ...
            battleDialogBox.SetPokemonMovements(playerUnit.Pokemon.Moves);
            yield return battleDialogBox.SetDialog($"¡{playerPokemon.Base.Name} te elijo a ti!");
    ...
    IEnumerator YesNoChoice(Pokemon newTrainerPokemon)
    {
        ...
        yield return battleDialogBox.SetDialog(
            $"{trainer.TrainerName} va a sacar a {newTrainerPokemon.Base.Name}.  ¿Quieres cambiar a tu Pokemon?");
    ...
    void HandlePlayerPartySelection()
    {
        ...
        if (Input.GetAxisRaw("Submit") != 0)
        {
            ...
            {
                partyHUD.SetMessage("No puedes seleccionar al pokemon en batalla");
                return;
            }
    ...
    bool MoveHits(Move move, Pokemon attacker, Pokemon target)
    {
        ...
        float accuracy = attacker.StatsBoosted[Stat.Precision];
    ...
    IEnumerator ShowDamageDescription(DamageDescription desc)
    {
        ...
        if (desc.Type > 1)
        {
            yield return battleDialogBox.SetDialog("¡Es superefectivo!");
        }
        else if (desc.Type < 1)
        {
    ...
    IEnumerator ThrowPokeball()
    {
        ...
        var pokeballInst =
            Instantiate(pokeball, playerUnit.transform.position + new Vector3(-2, 0), Quaternion.identity);
        ...
        if (numberOfShakes == 4)
        {
            ...
            {
                yield return battleDialogBox.SetDialog($"{enemyUnit.Pokemon.Base.Name} ha sido enviado al PC");
            }
    ...
    IEnumerator TryToEscapeFromBattle()
    {
        ...
        {
            float oddsScape = Mathf.FloorToInt(playerSpeed * 128 / enemySpeed) + 30 * escapeAttempts % 256;
            ...
            while (playerUnit.Pokemon.NeedsToLevelUp())
            {
                ...
                if (newLearnableMove != null)
                {
                    ...
                    else
                    {
                        ...
                        yield return battleDialogBox.SetDialog(
                            $"Pero no puede aprender mas de {PokemonBase.NUMBER_OF_LEARNABLE_MOVES} movimientos");
